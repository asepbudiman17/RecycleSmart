...
<head>
    <meta charset="UTF-8">
    <title>Reset Password - RecycleSmart</title>
...
<div class="login-container">
    ...
    <form action="<?= site_url('login/reset_password_process'); ?>" method="POST">
        <div class="form-group">
            <input type="text" class="form-control" name="kode_reset" placeholder="Kode Reset" required>
            <span class="form-control-icon"><i class="fas fa-shield-alt"></i></span>
        </div>
        <div class="form-group">
