        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">Tambah Kategori Sampah</h4>
                </div>
                <div class="card-body">
                    <?php echo form_open('waste_category/create'); ?>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control <?php echo form_error('description') ? 'is-invalid' : ''; ?>" 
                                      id="description" name="description" rows="4"><?php echo set_value('description'); ?></textarea>
                            <div class="invalid-feedback">
